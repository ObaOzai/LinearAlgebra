...
"""
Code intended to solve 2x2 and 3X3 Matrix basic problems
...
def main():
    while True:
        ...
        if invertible:
            ...
            if solution is not None:
                print("\nNon-singular matrix with one unique solution.")
        ...
        cont = input("\nWould you like to solve another system? (y/n): ").strip().lower()
        if cont != 'y':
